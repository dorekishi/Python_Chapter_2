...
#
print(f'\nSorry everyone but I found out I can actually only invite 2 of yall 😭')
#
print(f'\nFarewell {invitees[0].title()}, sorry for the abruptness of my decision to uninvite you.')
invitees.pop(0)
print(f'Farewell {invitees[0].title()}, sorry for the abruptness of my decision to uninvite you.')
invitees.pop(0)
print(f'Farewell {invitees[1].title()}, sorry for the abruptness of my decision to uninvite you.')
invitees.pop(1)
print(f'Farewell {invitees[2].title()}, sorry for the abruptness of my decision to uninvite you.')
invitees.pop(2)
print(f'Farewell {invitees[2].title()}, sorry for the abruptness of my decision to uninvite you.')
invitees.pop(2)
print(f'Farewell {invitees[2].title()}, sorry for the abruptness of my decision to uninvite you.')
...
invitees.pop(2)
#
print(f"\nHi {invitees[0].title()},\nJust letting you know you're still invited :)")
print(f"\nHi {invitees[0].title()},\nJust letting you know you're still invited :)")
#
del invitees[0]
del invitees[0]
